...
\dates{\bf  January 2013 - December 2020 }
\begin{position}
...
\item Signing of the cooperation agreement with the Universidad Nacional de Colombia (Facultad de Ingeniería – October 2010)
\item Signing of the cooperation agreement with the Universidad Minuto de Dios – \#OpenLAB (Facultad de Ingeniería – February 2017)
\end{itemize}
...
\vspace{0.5cm}
\begin{itemize}
	\item Formulación y Gestión de Proyectos de Cooperación Internacional, \textit{Cámara Junior Internacional - JCI} (December 2010)
	\item Administración y Gestión de Proyectos: Plan de contingencia para el acompañamiento y formulación de proyectos de investigación regional que apliquen al Fondo de Ciencia, Tecnología e Innovación del Sistema General de Regalías, \textit{Centro de Investigaciones y Desarrollo Científico - CIDC, UDFJC} (July 2012)
	\item Encuentro de Universidad y Cooperación: Entre la Cooperación Académica, la Cooperación Universitaria al Desarrollo y la Responsabilidad Social, \textit{Fundación Universitaria del Área Andina} (August 2013)
	...
	\item 1er Foro Regional Producción Agroecológica en el Tropico, \textit{Corporación Universitaria Minuto de Dios - UNIMINUTO - Vicerrectoría Regional Llanos} (September 2014)
	\item Comité Organizador, IV Congreso Internacional GIEI, \textit{Interdisciplinar de Investigación en Educación e Inclusión - GIEI, UDFJC} (October 2018)
