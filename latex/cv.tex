...
\begin{position}
	Development, support, maintenance of services, utilities, tools and interactive content of the web platform of the \textit {Centro de Relaciones Interinstitucionales - CERI}. It includes Agreements Directory, International Students Aplication System (academic mobility), API integration with the academic management system. This initiative was recognized by the \href {https://www.cna.gov.co}{CNA} in 2013, as a best good practices in internacionalization in Colombia, within the framework of high quality accreditation: \url {https://www.cna.gov.co/1741/article-320722.html}
\end{position}
