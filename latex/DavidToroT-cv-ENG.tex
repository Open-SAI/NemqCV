...
\begin{itemize}
	...
	\begin{itemize}
	 ...
	 \end{itemize}
 \item OpenCL (Open Computing Language), MPI (Message Passing Interface) in C\slash C++ and Python, over a Beowulf MOSIX and a Pelican HPC cluster, to support galaxy spectral analysis in the \href{http://chronos.udistrital.edu.co:8095/siciud/web/Consultas.x?accion=5&idSemillero=2382}{COMPUCIE \faIcon{external-link-alt}} team 
